...
#include <memory>
#include "../../MyGobang/src/dialog/createroomdialog.h"
...
QT_MOC_LITERAL(1, 17, 13), // "sigCreateRoom"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 8), // "roomName"
QT_MOC_LITERAL(4, 41, 9), // "chessType"
QT_MOC_LITERAL(5, 51, 8) // "isPublic"

    },
    "CreateRoomDialog\0sigCreateRoom\0\0"
    "roomName\0chessType\0isPublic"
};
...
void CreateRoomDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CreateRoomDialog::*)(const QString & , const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CreateRoomDialog::sigCreateRoom)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CreateRoomDialog::sigCreateRoom(const QString & _t1, const QString & _t2, const QString & _t3)
{
