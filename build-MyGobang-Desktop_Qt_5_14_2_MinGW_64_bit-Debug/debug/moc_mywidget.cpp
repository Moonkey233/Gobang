...
#include <memory>
#include "../../MyGobang/src/widget/mywidget.h"
...
QT_MOC_LITERAL(1, 9, 18), // "changeWidgetSignal"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 10) // "widgetName"

    },
    "MyWidget\0changeWidgetSignal\0\0widgetName"
};
...
void MyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeWidgetSignal((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWidget::changeWidgetSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyWidget::changeWidgetSignal(const QString & _t1)
{
